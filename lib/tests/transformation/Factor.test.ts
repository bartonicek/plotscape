...
// describe("Factor", () => {
//   test.skip(`Factor.from assigns indices correctly`, () => {
...
//   test.skip(`Factor.bin assigns indices correctly`, () => {
...
//   test.skip(`Factor.product assigns indices correctly (first factor precedence)`, () => {
